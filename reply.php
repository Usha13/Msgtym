...
<table border="1" cellpadding="10">
  <tr><td class="l">To</td>
       <td><input class="ip1" type="text" name="v1" value="<?php echo $sid; ?>" style="width:500px;" readonly></td>
  </tr>
  ...
  <tr>
    <td colspan="2" id="ex"><input  id="b" type="submit" value="Send" name="btn" style="margin-left:180px;">
	<input type="submit" id="b"  value="Cancel" name="btn2"  style="margin-left:180px;"></td>
	</tr>
